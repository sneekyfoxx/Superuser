...
╚══════╝ ╚═════╝ ╚═╝     ╚══════╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚══════╝╚═╝  ╚═╝
  ...
  stdout.write("     {cyan}match{reset}:{green}entry{reset}\t\t {yellow}match an{reset} '{green}entry{reset}'\n\n".fmt)
  ...
  stdout.write("     {cyan}match{reset}:{green}entry{reset}\t\t {yellow}the{reset} '{green}entry{reset}' {yellow}to search for{reset}\n\n".fmt)
  stdout.write("     {cyan}mode{reset}:[{green}passive{reset}|{green}strict{reset}]\t {yellow}method used for finding{reset} '{green}entry{reset}'\n".fmt)
  stdout.write("         {green}passive{reset}\t\t {yellow}find all paths containing{reset} '{green}entry{reset}'\n\n".fmt)
  stdout.write("         {green}strict{reset}\t\t\t {yellow}find all paths ending in{reset} '{green}entry{reset}'. ({red}default{reset})\n\n".fmt)

...
╚══════╝ ╚═════╝ ╚═╝     ╚══════╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚══════╝╚═╝  ╚═╝
  ...
  stdout.write("({red}/{reset}{yellow}'s and{reset} {red}\\{reset}{yellow}'s are{reset} {red}invalid{reset})\n".fmt)
  stdout.write("     {cyan}use{reset}:{green}path{reset}\t\t\t {yellow}the location to be searched{reset}\n\n".fmt)
